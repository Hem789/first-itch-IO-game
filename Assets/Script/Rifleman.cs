    ...
    void OnAnimatorIK()
    {
       Player=GameObject.FindWithTag("Player");
        ...
        if(walk.shoot==true)
        {
            ...
            gun.transform.position=transform.position+new Vector3(0,1.4F,0);//+transform.right*.15F-transform.forward*.2F;
            ...
            if(gun.transform.rotation.eulerAngles.y<=transform.rotation.eulerAngles.y-23)// && gun.transform.rotation.eulerAngles.y<=transform.rotation.eulerAngles.y+25)
            {
                gun.transform.rotation=Quaternion.Euler(gun.transform.rotation.eulerAngles.x,transform.rotation.eulerAngles.y-23,gun.transform.rotation.eulerAngles.z);
            }
            if(gun.transform.rotation.eulerAngles.y>=transform.rotation.eulerAngles.y+23)// || gun.transform.rotation.eulerAngles.y>transform.rotation.eulerAngles.y+25)
            {
                gun.transform.rotation=Quaternion.Euler(gun.transform.rotation.eulerAngles.x,transform.rotation.eulerAngles.y+23,gun.transform.rotation.eulerAngles.z);
